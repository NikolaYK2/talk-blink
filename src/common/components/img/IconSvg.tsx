...
export const IconSvg = ({name}: Props) => {
  switch (name) {
    case 'logo': {
      return <svg width="100%" height="100%" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect width="48" height="48" fill="white"
              fillOpacity="0.01"/>
        <path d="M44 16V36H29L24 41L19 36H4V6H34" stroke="#000000"
    ...
    case 'facebook': {
      return <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="100%" height="100%">
        <linearGradient id="awSgIinfw5_FS5MLHI~A9a" x1="6.228" x2="42.077" y1="4.896" y2="43.432"
